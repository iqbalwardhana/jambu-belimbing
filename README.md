# Deployment Model CNN (Jambu vs Belimbing)

## Deskripsi singkat

Repository ini berisi semua file yang dibutuhkan untuk melakukan deployment model Machine Learning Image Classification menggunakan CNN (Convolutional Neural Network). Adapun model yang digunakan merupakan model untuk memprediksi gambar Jambu vs belimbing.

#

## Sekilas mengenai input model

Agar dapat memprediksi Jambu atau Belimbing, data input model harus mengikuti format sebagai berikut:
